...
export async function GET() {
  try {
    ...
    // 2. Local Fallback: Load from local files (wrapped in try-catch to prevent crashes in serverless/edge environments)
    try {
      ...
      console.warn("Local filesystem fallback skipped: fs operations not supported in this runtime.");
    }
